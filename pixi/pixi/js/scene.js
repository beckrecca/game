...
function northWestScene() {
	...
	treesVertical = quickSpriteRepeaterVertical(decorTextures["plant.png"], 12, 0, 1.25);
	...
	quickSpriteAdd(buildTextures,buildTextureMap.get("castle-light-TL"), houseContainer, 0);
	quickSpriteAdd(buildTextures,buildTextureMap.get("castle-light-none"), houseContainer, 1);
	quickSpriteAdd(buildTextures,buildTextureMap.get("castle-light-none"), houseContainer, 2);
	quickSpriteAdd(buildTextures,buildTextureMap.get("castle-light-none"), houseContainer, 3);
	quickSpriteAdd(buildTextures,buildTextureMap.get("castle-light-TR"), houseContainer, 4);
	quickSpriteAdd(buildTextures,buildTextureMap.get("castle-light-TL"), houseContainer, 0,1);
	quickSpriteAdd(buildTextures,buildTextureMap.get("castle-light-TR"), houseContainer, 1,1);
	quickSpriteAdd(buildTextures,buildTextureMap.get("castle-light-TL"), houseContainer, 2,1);
	quickSpriteAdd(buildTextures,buildTextureMap.get("castle-light-TL"), houseContainer, 3,1);
	quickSpriteAdd(buildTextures,buildTextureMap.get("castle-light-TR"), houseContainer, 4,1);
	...
	quickSpriteAdd(buildTextures,buildTextureMap.get("castle-shadow-BR"), houseDetails, 1, 2);
	quickSpriteAdd(buildTextures,buildTextureMap.get("castle-shadow-BL"), houseDetails, 3, 2);
